...
const Row = ({ rowData, key, mapWidth,currentTile,tileHeight, tileWidth, selectedTile, layerOrder, transactionStack, editDataMap}) => {
    ...
    return(
        <div className="row">{
            rowData.map((tile, index) =>{
                ...
                layerOrder={layerOrder} transactionStack = {transactionStack} editDataMap = {editDataMap}></Pixel>
            })
        }</div>
    )
}
