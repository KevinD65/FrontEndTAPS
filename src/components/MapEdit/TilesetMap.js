...
export default function TilesetMap({ currentTile, setCurrentTile}) {
 ...
 return (
    ...
    {openTS && <SelectGrid gridPoints={grid_points}  currentTile={currentTile} setCurrentTile={setCurrentTile}/>}
